/**
	...
	@desc
		...
		<codeblock>
			adData.elements.AlphaVideoPlayer = new AlphaVideoPlayer ({
			...
			adData.elements.AlphaVideoPlayer.play();
		</codeblock>
		<br><br>
...
import { CanvasDrawer, CanvasImage, CanvasUtils } from 'ad-view'
...
var AlphaVideoPlayer = function(arg) {
	...
	if (isStatic) {
		...
		if (!_isMpg) throw new Error('You want to use a dynamic masking solution: video format must be, and is not, .MPG');
	...
	function updateStatic() {
		// trace('AlphaVideoPlayer.updateStatic()');
		outputCanvas.update();
	}

	function updateDynamic() {
		// trace('AlphaVideoPlayer.updateDynamic()');
		maskCanvas.update();
	...
	function handleComplete(event) {
		trace('AlphaVideoPlayer.handleComplete()');
