...
function VideoPlayer(arg) {
	...
	*/
			...
			import('./mpg/MpegPlugin')
				.then(module => {
					...
					V.screen = video = _mpeg = new MpegPlugin({
						...
						autoplay: false,
						onReady: () => {
							console.warn('MpegPlugin.onReady:')
							handleCanPlay()
	...
	function handleError(event) {
		// MpegPlugin throws an error regardless, so ignore it
		if (_mpeg) return
		// console.log(':: VideoPlayer :: handleError()', event)
